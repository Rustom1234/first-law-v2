 ...
 * a repo link or a project image not yet supplied.
 *
 ...
 *
 * Logos: real official marks pulled from each org's own site/Wikimedia, not
 * invented. Wan Lab has no public logo, so a generic cell icon stands in.
 *
...
export const resume: ResumeData = {
  profile: {
    ...
    portrait: assetUrl('images/me.webp'),
    bio: [
  ...
  // Sourced from the July 2026 resume.
  experience: [
    {
      title: 'AI Solutions Engineer Intern',
      org: 'ContinuServe',
      logo: assetUrl('images/continuserve.png'),
    ...
    },
    {
      ...
      logo: assetUrl('logos/haverford-squirrel.png'),
    ...
    },
    {
      ...
      logo: assetUrl('logos/equitech-futures.svg'),
    ...
    },
    {
      ...
      logo: assetUrl('images/haverford-mathiesonlab.png'),
  ...
  projects: [
    {
      ...
      image: assetUrl('images/greenbone.png'),
      blurb:
    ...
    },
    {
      ...
      image: assetUrl('images/boostedtransformers.webp'),
      blurb:
    ...
    },
    {
      ...
      image: assetUrl('images/morphology.png'),
      blurb:
    ...
    },
    {
      ...
      image: assetUrl('images/t20score.webp'),
      blurb:
    ...
    },
    {
      ...
      image: assetUrl('images/hyena.webp'),
      blurb:
    ...
    {
      title: 'Connect4Bot',
      image: assetUrl('images/connect4.png'),
      blurb: 'A Connect Four bot using the minimax algorithm with alpha-beta pruning, with a Pygame UI.',
      tags: ['Minimax', 'Alpha-Beta Pruning', 'Pygame'],
  ...
  education: [
    {
      ...
      logo: assetUrl('logos/upenn-bright.svg'),
      period: 'Incoming',
    ...
    },
    {
      ...
      org: 'UWCSEA Dover',
      logo: assetUrl('images/UWC.png'),
      period: 'Aug 2021 – May 2023',
      blurb: 'United World College South East Asia, Dover campus. IB Diploma.',
      gpa: undefined,
      coursework: [],
    },
  ],
  ...
  paper: {
    ...
    image: assetUrl('images/researchpaper.png'),
  },
};
